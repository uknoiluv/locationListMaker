...
//var app = angular.module('map', ['google-maps'.ns(), 'ui.router']);
  'use strict';
  angular.module('map', ['google-maps'.ns(), 'ui.router', 'findPlace', 'customButton', 'savedList', 'searchHistory'])
  // .config(['GoogleMapApiProvider'.ns(), '$stateProvider', '$urlRouterProvider', function (GoogleMapApi, $stateProvider, $urlRouterProvider) {
    .config(['GoogleMapApiProvider'.ns(), '$urlRouterProvider', function (GoogleMapApi, $urlRouterProvider) {
